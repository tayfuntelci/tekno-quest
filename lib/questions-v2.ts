...
export const questions: Question[] = [
  ...
  // ─────────────────────────────────────────────
  {
    id: 10, type: 'mcq',
    section: '🤖 Yapay Zeka',
    text: 'Aşağıdakilerden hangisi günlük hayatta yapay zekanın yaptığı bir iştir?',
    options: ['Telefonda yüz tanıyıp kilidi açmak', 'Çamaşırları elde yıkamak', 'Kalemle resim çizmek', 'Bisiklet sürmek'],
    correct: 'Telefonda yüz tanıyıp kilidi açmak',
    explanation: '📱 Telefonda yüz tanıma, YouTube önerileri ve navigasyonun trafik tahmini — hepsi yapay zeka! YZ\'yi her gün farkında olmadan kullanıyoruz.',
    xp: 12,
  },
  {
    id: 11, type: 'tf',
    ...
    correct: 'false',
    explanation: '❌ Yanlış! Telefonda yüz tanıma, fotoğraf albümü ve navigasyon gibi birçok yapay zeka çalışıyor!',
    xp: 10,
  },
  {
    id: 12, type: 'mcq',
    ...
    options: ['ChatGPT', 'Midjourney', 'Gemini', 'Bisiklet 🚲'],
    correct: 'Bisiklet 🚲',
    explanation: '🚲 Bisiklet bir ulaşım aracı! ChatGPT, Midjourney ve Gemini ise yapay zeka araçlarıdır.',
    xp: 10,
  },
